<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="{{ Auth::check() && Auth::user()->isAdmin() ? route('admin.dashboard') : (Auth::check() && Auth::user()->isKaryawan() ? route('karyawan.dashboard') : route('login')) }}">
                ...
                @else
                    @if(Auth::user()->isAdmin())
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle {{ request()->routeIs('admin.gaji.*') ? 'active' : '' }}" href="#" id="gajiDropdownAdmin" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Penggajian
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="gajiDropdownAdmin">
                                <li><a class="dropdown-item" href="{{ route('admin.gaji.form_hitung') }}">Hitung Gaji</a></li>
